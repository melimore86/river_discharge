...
d1=read.csv("Choc_flow_1931_2012.csv")                             
str(d1)                                                               
head(d1)                                                              
...
# -------------------------- pre 2000 ---------------------------------------- #
test = which(substr(d1$Date,1,4)=='2000')[1]     # find which row a specific year starts
pre_2000 = d1[1:25202,]                          # Pre 2000 data
head(pre_2000)
...
# ---------------------------- 2008-2012 ------------------------------------- #
d08_12 = d1[24199:29904,]                  # 2008-2012 data 
head(d08_12)
...
boxplot(m_avg_pre_2000[,1:12], main='Mean Monthy Discharge Choctawhatchee River')    #  , col='lightblue'
